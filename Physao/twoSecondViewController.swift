...
class twoSecondViewController: UIViewController, CBCentralManagerDelegate, CBPeripheralDelegate {
    ...
    override func viewDidLoad() {
        ...
        dartView.frame = CGRectMake(92, 88, 100, 100) // default position
    ...
    */
    ...
    func startAnimation() { // to trigger the animation
        ...
        path.addCurveToPoint(CGPoint(x: 142, y: 136), controlPoint1: CGPoint(x: 249, y: 305), controlPoint2: CGPoint(x: 196, y: 221))
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if(segue.identifier == "twoFeed") {
            if let destinationVC = segue.destinationViewController as? UINavigationController {
                var dest = destinationVC.topViewController as? ImmediateFeedbackViewController
